...
python -m PyInstaller --clean --noconfirm --onefile --windowed --name "TA Invoices and Estimates" --icon "app_icon.ico" --hidden-import pypdf --add-data "logo_grayblue_transparent.png;." adael_desktop.py

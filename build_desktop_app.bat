...
python -m PyInstaller --clean --noconfirm --onefile --windowed --name "TA Invoices and Estimates" --icon "app_icon.ico" --hidden-import pypdf --collect-data certifi --add-data "logo_grayblue_transparent.png;." --add-data "watermark_estimate.png;." adael_desktop.py
